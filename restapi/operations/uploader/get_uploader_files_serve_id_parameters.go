...
func NewGetUploaderFilesServeIDParams() GetUploaderFilesServeIDParams {
	...
	return GetUploaderFilesServeIDParams{}
}

// GetUploaderFilesServeIDParams contains all the bound params for the get uploader files serve ID operation
...
func (o *GetUploaderFilesServeIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetUploaderFilesServeIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
