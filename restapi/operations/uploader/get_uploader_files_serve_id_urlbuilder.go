...
func (o *GetUploaderFilesServeIDURL) WithBasePath(bp string) *GetUploaderFilesServeIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetUploaderFilesServeIDURL) Build() (*url.URL, error) {
	...
	var _path = "/uploader/files/serve/{id}"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetUploaderFilesServeIDURL")
	}
...
func (o *GetUploaderFilesServeIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetUploaderFilesServeIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetUploaderFilesServeIDURL")
	}
