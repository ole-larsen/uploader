...
func NewGetUploaderFilesParams() GetUploaderFilesParams {
	...
	return GetUploaderFilesParams{}
}

// GetUploaderFilesParams contains all the bound params for the get uploader files operation
...
func (o *GetUploaderFilesParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
