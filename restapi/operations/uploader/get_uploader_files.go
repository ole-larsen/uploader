...
func (fn GetUploaderFilesHandlerFunc) Handle(params GetUploaderFilesParams, principal *models.Principal) middleware.Responder {
...
func NewGetUploaderFiles(ctx *middleware.Context, handler GetUploaderFilesHandler) *GetUploaderFiles {
	return &GetUploaderFiles{Context: ctx, Handler: handler}
}
...
func (o *GetUploaderFiles) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetUploaderFilesParams()
