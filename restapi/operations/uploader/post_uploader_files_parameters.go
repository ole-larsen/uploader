...
// PostUploaderFilesMaxParseMemory sets the maximum size in bytes for
...
func NewPostUploaderFilesParams() PostUploaderFilesParams {
	...
	return PostUploaderFilesParams{}
}

// PostUploaderFilesParams contains all the bound params for the post uploader files operation
...
func (o *PostUploaderFilesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if err := r.ParseMultipartForm(PostUploaderFilesMaxParseMemory); err != nil {
...
func (o *PostUploaderFilesParams) bindAlt(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostUploaderFilesParams) bindCaption(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostUploaderFilesParams) bindFile(file multipart.File, header *multipart.FileHeader) error {
	return nil
}

// bindHeight binds and validates parameter Height from formData.
func (o *PostUploaderFilesParams) bindHeight(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostUploaderFilesParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostUploaderFilesParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostUploaderFilesParams) bindProvider(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostUploaderFilesParams) bindSize(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostUploaderFilesParams) bindType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *PostUploaderFilesParams) bindWidth(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
